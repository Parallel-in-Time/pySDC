...
from implementations.transfer_classes.TransferParticles_NoCoarse import particles_to_particles

from examples.tutorial.step_4.PenningTrap_3D_coarse import penningtrap_coarse
