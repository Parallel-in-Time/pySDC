...
from pySDC_implementations.datatype_classes.complex_mesh import mesh, rhs_imex_mesh
from pySDC_implementations.problem_classes.FastWaveSlowWave_0D import swfw_scalar
