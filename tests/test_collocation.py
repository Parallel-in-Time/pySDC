...
def check_canintegratepolynomials(collclass,t_start,t_end):
    ...
    for M in range(2,13):
        ...
        assert abs(int_ex - int_coll) < 5e-14, "For node type " + coll.__class__.__name__ + ", failed to integrate polynomial of degree " + str(coll.order-1) + " exactly. Error: %5.3e" % abs(int_ex - int_coll)
