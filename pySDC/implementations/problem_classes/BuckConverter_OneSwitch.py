...
class buck_converter_oneswitch(ptype):
    """
    Example implementing the buck converter model as in the description in the PinTSimE project
    This problem class executes only one switch (for test purposes)
    Attributes:
    ...
    def __init__(self, problem_params, dtype_u=mesh, dtype_f=imex_mesh):
        ...
        essential_keys = ['t_switch', 'dt_rest', 'Vs', 'Rs', 'C1', 'Rp', 'L1', 'C2', 'Rl']
        ...
        super(buck_converter_oneswitch, self).__init__(init=(problem_params['nvars'], None,
                                                       np.dtype('float64')), dtype_u=dtype_u, dtype_f=dtype_f,
