...
class fermi_pasta_ulam_tsingou_imex(ptype):
    """
    ...
    def __init__(self, problem_params, dtype_u, dtype_f):
        ...
        super(fermi_pasta_ulam_tsingou_imex, self).__init__(problem_params['npart'], dtype_u, dtype_f, problem_params)

        self.A = self.__get_A(self.params.npart)

    @staticmethod
    def __get_A(N):
        """
        Helper function to assemble implicit matrix A in sparse format
