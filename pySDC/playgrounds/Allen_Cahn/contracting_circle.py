...
from pySDC.implementations.problem_classes.AllenCahn_2D_FD import allencahn_fullyimplicit, allencahn_semiimplicit, allencahn_semiimplicit_v2, allencahn_multiimplicit, allencahn_multiimplicit_v2
...
def main():
    ...
    description = dict()
    description['problem_class'] = allencahn_semiimplicit#allencahn_fullyimplicit
    ...
    controller = allinclusive_multigrid_nonMPI(num_procs=8, controller_params=controller_params,
