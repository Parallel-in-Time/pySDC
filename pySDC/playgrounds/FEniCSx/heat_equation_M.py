...
from pySDC.implementations.problem_classes.HeatEquation_1D_FEniCSx_matrix_forced import fenicsx_heat, fenicsx_heat_mass
...
def run_simulation(ml=None, mass=None):
    ...
    if mass:
        ...
        description['problem_class'] = fenicsx_heat
