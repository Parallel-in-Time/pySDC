...
def plot_accuracy(results):
    ...
    fname = path + 'heat_equation_5th_Order_time_FEniCS.png'
...
def main():
    ...
    # visualize results
    # results = {ID(dt=0.2): 0.00015393481200369803, ID(dt=0.1): 1.9698745098235166e-05, ID(dt=0.05): 2.4379065402976406e-06, ID(dt=0.025): 2.8191207478282644e-07, 'dt_list': [0.2, 0.1, 0.05, 0.025]}
