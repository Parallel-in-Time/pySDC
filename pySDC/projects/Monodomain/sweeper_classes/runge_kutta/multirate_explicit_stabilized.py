...
class multirate_explicit_stabilized(sweeper):
    ...
    def update_nodes(self):
        ...
        for m in range(M):
            ...
            P.eval_f(L.u[m + 1], L.time + L.dt * self.coll.nodes[m], eval_impl=True, eval_expl=True, eval_exp=False, fh=L.f[m + 1])
    ...
    def predict(self):
        ...
        P.eval_f(L.u[0], L.time, eval_impl=True, eval_expl=True, eval_exp=False, fh=L.f[0])
        ...
        for m in range(1, self.coll.num_nodes + 1):
            ...
            if self.params.initial_guess == "spread":
                ...
                P.eval_f(L.u[m], L.time + L.dt * self.coll.nodes[m - 1], eval_impl=True, eval_expl=True, eval_exp=False, fh=L.f[m])
