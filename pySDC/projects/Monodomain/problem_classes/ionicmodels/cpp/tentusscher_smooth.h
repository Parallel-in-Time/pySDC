...
void TenTusscher2006_epi_smooth::f_nonstiff(py::list y_list, py::list fy_list)
{
    double *y_ptrs[size];
    double *fy_ptrs[size];
    size_t N;
...
void TenTusscher2006_epi_smooth::f_stiff(py::list y_list, py::list fy_list)
{
    double *y_ptrs[size];
    double *fy_ptrs[size];
    size_t N;
...
double TenTusscher2006_epi_smooth::rho_f_nonstiff()
{
    return 6.5;
}
